...
async def shorten(payload: ShortenRequest, request: Request, session: AsyncSession = Depends(get_session), redis=Depends(init_redis)):
    try:
...
async def redirect_short(short_code: str, request: Request, session: AsyncSession = Depends(get_session), redis=Depends(init_redis)):
...
async def stats(short_code: str, request: Request, session: AsyncSession = Depends(get_session), redis=Depends(init_redis)):
